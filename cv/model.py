...
def run_odt_and_draw_results(img, image_path, interpreter, threshold=0.5, data_face_emb = None):
  ...
  if image_path != None : 
    preprocessed_image, original_image = preprocess_image_from_path(
        image_path,
  ...
  for obj in results:
    ...
    if obj['score'] > threshold:
      ...
      face  = original_image_np[ymin:ymax,xmin:xmax]
  ...
  return original_uint8, objects_position